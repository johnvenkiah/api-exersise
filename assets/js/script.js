const API_KEY = "bdrauwgQD7LfTgn9GCy5KOXStvQ";
...
function displayStatus(data) {
    let modTitle = document.getElementById("resultsModalTitle");
    let modBody = document.getElementById("results-content");

    modTitle.innerText = "API Key Status";
    modBody.innerText = `Your key is valid until ${data.expiry}`;
    resultsModal.show();
